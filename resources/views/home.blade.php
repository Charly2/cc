...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 row-cont-info">
            ...
            <div onclick="location.href='{{url('expedientes.index')}}' " id="sensor_expediente" onmouseover="destaca('home_boton_expediente');" onmouseleave="restaura();"></div>
            <div onclick="location.href='{{url('expedientes.index')}}' " id="sensor_importacion" onmouseover="destaca('home_boton_importacion');" onmouseleave="restaura();"></div>
